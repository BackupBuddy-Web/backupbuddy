...
async function loadCheckinStatus() {
    ...
    if (!checkinData) {
        ...
        if (insertError) { console.error('Error creating check-in:', insertError); return; }
        checkinData = newData;
    }
    ...
    saveFrequencyBtn.onclick = async function() {
        ...
        if (updated) {
            ...
            setTimeout(() => {
                saveFrequencyBtn.textContent = 'Save Frequency';
